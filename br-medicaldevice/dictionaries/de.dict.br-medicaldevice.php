...
Dict::Add('DE DE', 'German', 'Deutsch', array(
    ...
    'Class:MedicalDicomCommunicationLink+' => 'Definiert eine genehmigte Kommunikationsbeziehung zwischen zwei DICOM-Application-Entities.',
    ...
    'Class:MedicalDicomCommunicationLink/Attribute:source_ae_id+' => 'DICOM-Application-Entity, die die Kommunikation initiiert.',
    ...
    'Class:MedicalDicomCommunicationLink/Attribute:target_ae_id+' => 'DICOM-Application-Entity, die die Kommunikation empfängt.',
    ...
    'Class:MedicalDicomCommunicationLink/Error:SourceEqualsTarget' => 'Quelle und Ziel dürfen nicht dieselbe DICOM Application Entity sein.',
    'Class:MedicalDicomCommunicationLink/Error:InvalidSourceRole' => 'Die Quell-DICOM-Application-Entity darf nicht ausschließlich als SCP konfiguriert sein.',
    'Class:MedicalDicomCommunicationLink/Error:InvalidTargetRole' => 'Die Ziel-DICOM-Application-Entity darf nicht ausschließlich als SCU konfiguriert sein.',
));
