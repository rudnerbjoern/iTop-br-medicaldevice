...
Dict::Add('DE DE', 'German', 'Deutsch', array(
    ...
    'Class:MedicalDicomApplicationEntity/Attribute:protocol' => 'Porttyp / Protokoll',
    'Class:MedicalDicomApplicationEntity/Attribute:protocol+' => 'Art der DICOM-Kommunikation bzw. des verwendeten Protokolls für diesen Netzwerkendpunkt.',
    'Class:MedicalDicomApplicationEntity/Attribute:protocol/Value:dicom' => 'DICOM',
    'Class:MedicalDicomApplicationEntity/Attribute:protocol/Value:dicom+' => 'Klassische DICOM-Kommunikation über TCP.',
    'Class:MedicalDicomApplicationEntity/Attribute:protocol/Value:dicom_tls' => 'DICOM TLS',
    'Class:MedicalDicomApplicationEntity/Attribute:protocol/Value:dicom_tls+' => 'DICOM-Kommunikation über eine TLS-gesicherte TCP-Verbindung.',
